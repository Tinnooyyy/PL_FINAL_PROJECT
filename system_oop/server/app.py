"""
The web server of the OOP System.
...
Start it from the project root with:   python system_oop/server/app.py
or from inside the system_oop folder:  python server/app.py
"""
...
# The system_oop folder. Putting it on the import path lets us import this
