...
SCRIPT = [
    ("add_task", ({"title": "  Buy milk ", "priority": "LOW", "due_date": "2026-10-05"},)),
    ("add_task", ({"title": "Pay rent", "priority": "high", "due_date": "2026-10-01",
                   "description": "Landlord"},)),
    ("add_task", ({"title": "Read book", "description": "milk chapter"},)),
    ("add_task", ({"title": "Plan trip", "priority": "high", "due_date": "2026-10-01"},)),
    ("add_task", ({"title": ""},)),
    ...
    ("update_task", (3, {"priority": "high", "due_date": "2026-09-30"})),
    ...
    ("query_tasks", ("milk", None, None, None, False)),
    ("delete_task", (2,)),
    ("save_tasks", ()),
    ("load_tasks", ()),
    ("get_all_tasks", ()),
